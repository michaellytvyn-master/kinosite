			...
			connection.query(countQuery, countParams, (err, countResult) => {
				...
				connection.query(getPopularMoviesQuery, (err, popularResults) => {
					...
					res.render('index', {
						...
						description: 'Смотрите лучшие фильмы онлайн бесплатно на kino-magnit. Выберите кино на любой вкус и наслаждайтесь просмотром в хорошем качестве без регистрации.',
						keywords: 'kino-magnit, смотреть фильмы онлайн, новинки кино, лучшие фильмы, бесплатные фильмы, фильмы в хорошем качестве, онлайн кинотеатр, популярные фильмы, последние фильмы, кино 2024, фильмы HD, жанры фильмов, боевики, комедии, драмы, фантастика',
