...
router.get('/', async (req, res) => {
	...
	function insertExampleMovie() {
		...
		connection.query(insertMovieQuery, [
			...
			console.log('Example movie inserted successfully with ID:', results.insertId)
			return res.status(200).json({ message: 'Movie inserted successfully', movieId: results.insertId })
		})
	}
